...
public class Map  implements Serializable {
    ...
    public String monstersFilePath = "monster.txt";
    ...
    public HashMap<Integer, Monster> hashMapMonster = new HashMap<Integer, Monster>();
    ...
    public void readFiles() {
        ...
        try {
            String line;
            BufferedReader bufferedReader = new BufferedReader(new FileReader(monstersFilePath)); // buffer reader used to read the file
            while ((line = bufferedReader.readLine()) != null) { // while loop that reads until the end of the file
                ...
                if (parts.length >= 6) {
                    ...
                    hashMapMonster.put(m.getMonsterID(), m); // used to add the values stored in the temp items to the hash map
